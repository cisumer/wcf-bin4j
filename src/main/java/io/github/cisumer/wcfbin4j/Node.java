...
public interface Node {
	 ...
	 * @throws IOException
	 */
	void renderContent(OutputStream os)throws Exception;
	/**
	...
	public static <T extends Node> T build(Class<T> cls) throws Exception{
		if(Node.class.isAssignableFrom(cls))
			return cls.newInstance();
		throw new NodeNotFoundException(cls);
	}
}
